function varargout = cameraWindowBody(varargin)
...
% Last Modified by GUIDE v2.5 02-Mar-2021 14:52:07

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @cameraWindowBody_OpeningFcn, ...
                   'gui_OutputFcn',  @cameraWindowBody_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function cameraWindowBody_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = cameraWindowBody_OutputFcn(hObject, eventdata, handles) 
...
vidobj3 = getappdata(0,'vidobj3');

if hObject.Value == 1
    set(hObject,'String','Stop Preview')
    pwin=image(zeros(480,640), 'Parent',handles.cameraAx3);
    preview(vidobj3,pwin)
else
...
% CAMERA_LOCATION = 'contra_eye';
CAMERA_LOCATION = 'body';
...
if hObject.Value == 1
    ...
    switch CAMERA_LOCATION
        case 'body'
            vidobj2 = addCam('671094318');
        case 'contra_eye'
            vidobj2 = addCam('02-2020C-07418');
    end
...
%    src.TriggerSource = 'Freerun';
    ...
    cam2.trialnum = 1;
    cam2.triggermode = 'Manual';
 %   TDT.setParameterValue('RZ5(1)','Cam2Manual',1);
...
%         TDT.setParameterValue('RZ5(1)','Cam2Manual',0);
% end
% 
