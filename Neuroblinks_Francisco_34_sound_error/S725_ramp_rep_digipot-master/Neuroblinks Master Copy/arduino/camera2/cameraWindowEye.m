function varargout = cameraWindowEye(varargin)
...
% Last Modified by GUIDE v2.5 02-Mar-2021 15:00:57

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @cameraWindowEye_OpeningFcn, ...
                   'gui_OutputFcn',  @cameraWindowEye_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
function cameraWindowEye_OpeningFcn(hObject, eventdata, handles, varargin)
...
function varargout = cameraWindowEye_OutputFcn(hObject, eventdata, handles) 
