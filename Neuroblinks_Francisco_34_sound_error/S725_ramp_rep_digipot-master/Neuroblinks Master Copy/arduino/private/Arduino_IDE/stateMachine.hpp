...
// This array size will allow us to do up to 60 seconds of readings at 5 ms intervals or 12 seconds at 1 ms intervals
#define MAX_DIFFERENTIAL_SENSOR_READINGS 12000
...
class SensorRepeating : public StateMachine {
    ...
    protected:
        ...
        int8_t readings[MAX_DIFFERENTIAL_SENSOR_READINGS]; //This array will contain the encoder reading codified in a differential way respect to the previous sample.

        timems_t first_time;
        timems_t last_time;
        int8_t times[MAX_DIFFERENTIAL_SENSOR_READINGS]; //This array will contain the encoder time codified in a differential way respect to the previous sample.
    ...
    public:
        ...
        void on();
        void off();
        timems_t getFirstTime();
        int32_t getFirstReading();
        int8_t getTime(int);
        int8_t getReading(int);
        void reset();
        void setNumRepeats(int);
