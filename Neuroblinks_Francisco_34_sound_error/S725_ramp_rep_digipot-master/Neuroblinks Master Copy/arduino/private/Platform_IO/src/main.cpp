...
AD9833 tone_generator(pin_ss_AD9833); //object to generate the sinusoidal tone signal with the AD9833 chip
MCP4131 tone_amplitude(pin_ss_MCP4131); //object to modulate the tone amplitude with the AD9833 chip
