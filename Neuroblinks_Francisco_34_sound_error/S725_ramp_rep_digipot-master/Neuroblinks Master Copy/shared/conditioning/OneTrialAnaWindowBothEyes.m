function varargout = OneTrialAnaWindowBothEyes(varargin)
...
% Last Modified by GUIDE v2.5 23-Sep-2021 13:08:58

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
    'gui_Singleton',  gui_Singleton, ...
    'gui_OpeningFcn', @OneTrialAnaWindowBothEyes_OpeningFcn, ...
    'gui_OutputFcn',  @OneTrialAnaWindowBothEyes_OutputFcn, ...
    'gui_LayoutFcn',  [] , ...
    'gui_Callback',   []);
...
function OneTrialAnaWindowBothEyes_OpeningFcn(hObject, eventdata, handles, varargin)
...
%We store this local function in the handles to call the function outside
%this file (in endOfTrial.m to autoupdate this windows after each trial)
handles.edit_trialnum_Callback = @edit_trialnum_Callback;
...
function varargout = OneTrialAnaWindowBothEyes_OutputFcn(hObject, eventdata, handles)
...
tnum_max=length(trials.eye);
str_tl={sprintf('Trial Viewer (%d-%d): %s',t_num,tnum_max,trials.eye(t_num).stimtype)};

% ------- for eye -----
subplot('position',[0.05 0.30 0.90 0.65], 'Parent', handles.uipanel_behavior)
cla
...
text(xlim1*[0.0; 0.20], -0.36, str_tl)
set(gca,'xlim',xlim1,'xtick',[-200:200:800])
