...
% Last Modified by GUIDE v2.5 12-Mar-2021 16:36:09
...
handles.image=imshow(roi((handles.y1:handles.y2)-1,(handles.x1:handles.x2)-1),'Parent',handles.axes_image);
...
handles.image2=imshow(roi(handles.y1:handles.y2,handles.x1:handles.x2),'Parent',handles.axes_image2);
