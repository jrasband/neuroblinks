function [y,t]=vid2eyetrace_2(data,metadata,varargin)
...
sr=metadata.cam_eye_2.fps;
sint=1./sr;
thresh=metadata.cam_eye_2.thresh;
st=-metadata.cam_eye_2.time(1)/1e3;
...
if w==1,  % ------- faster algorism --------
    ...
    binimage = (binimage & repmat(metadata.cam_eye_2.mask,[1 1 c d]));
    ...
    for i=1:d
        ...
        eyeimage=binimage.*metadata.cam_eye_2.mask;
        tr=sum(sum(eyeimage)); 
