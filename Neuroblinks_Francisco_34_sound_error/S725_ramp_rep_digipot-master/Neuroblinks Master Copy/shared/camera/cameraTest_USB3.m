...
h_preview=image(zeros(600,800),'Parent',ha);
...
% src.AcquisitionFrameRate=200;	% Our camera can sustain 200 FPS at full resolution (640x480) but can go up to 500 FPS if you reduce ROI or do vertical binning of frames
...
vidobj.FramesPerTrigger=1;		% We trigger for every frame acquired (value of 1) but this is definitely not necessary. You could, e.g. set this value to 200 if you want 1 second of video @ 200 FPS and then just trigger at the beginning
